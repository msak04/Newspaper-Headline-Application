...
public class Offline extends Stage {
	...
	Label l1 = new Label("Offline News Is Not Always Updated!!!");
	...
	btnlblpane.setPadding(new Insets(50,5,50,340));
	...
	this.setTitle("Offline News Site");
