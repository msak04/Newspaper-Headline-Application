...
public class NYTOnline extends Stage{
	...
	public NYTOnline() throws FileNotFoundException {
       
		try{
			Document doc = null;
	    doc = Jsoup.connect("https://www.nytimes.com/").get();
        File f = new File("NYT.txt");
    	...
    	o.println("Source: The NewYork Time");
    	o.println( "Last Update: "+td );
        o.println("News Website link : https://www.nytimes.com/" );

        Elements headlines = doc.select("h2.story-heading");
      ...
      //loading to file
    	...
    	i.close();
    		...
    		Label l1 = new Label("    The New York Times");
    		...
    		this.setTitle("Newyork Times Online News");
