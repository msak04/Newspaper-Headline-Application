...
public class ProthomAloOnline extends Stage{
	...
	public ProthomAloOnline() throws FileNotFoundException {
    	...
    	o.println("Source: The Dialy ProthomAlo");
    	o.println( "Last Update: "+td );

        
        Elements links = doc.select("a:contains(google)");
        for (Element link : links) {
            o.println("News Website link : " + link.attr("href"));
        }
      ...
      //loading to file
    	...
    	i.close();
    		...
    		this.setTitle("Prothom Alo Online News");
